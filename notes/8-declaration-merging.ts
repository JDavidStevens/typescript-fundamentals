...
const x = foo; // foo is in the value position (RHS). If something is a value, a variable should be able to hold it. 
...
export { foo, bar, baz }; // all are importable/exportable. Have to rely on tool tips to see if something is a namespace
